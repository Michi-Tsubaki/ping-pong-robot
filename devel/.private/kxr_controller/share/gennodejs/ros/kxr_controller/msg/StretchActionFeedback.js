...
let StretchFeedback = require('./StretchFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class StretchActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new StretchFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type StretchActionFeedback
    ...
    bufferOffset = StretchFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type StretchActionFeedback
    let len;
    let data = new StretchActionFeedback(null);
    ...
    data.feedback = StretchFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'kxr_controller/StretchActionFeedback';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StretchActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = StretchFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new StretchFeedback()
    }
...
module.exports = StretchActionFeedback;
