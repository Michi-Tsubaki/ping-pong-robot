...
class PressureControlAction(genpy.Message):
  _md5sum = "4f244247562e2847284a7b33d44f2e8a"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_H3f3I().pack(_x.action_goal.goal.board_idx, _x.action_goal.goal.trigger_pressure, _x.action_goal.goal.target_pressure, _x.action_goal.goal.release_duration, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.board_idx, _x.action_goal.goal.trigger_pressure, _x.action_goal.goal.target_pressure, _x.action_goal.goal.release_duration, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_H3f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_B():
    ...
    return _struct_B
_struct_H3f3I = None
def _get_struct_H3f3I():
    global _struct_H3f3I
    if _struct_H3f3I is None:
        _struct_H3f3I = struct.Struct("<H3f3I")
    return _struct_H3f3I
