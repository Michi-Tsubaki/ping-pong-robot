...
"""autogenerated by genpy from kxr_controller/PressureControlActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PressureControlActionGoal(genpy.Message):
  _md5sum = "7aec6e2d99481e8fc54c7e0715a478ce"
  _type = "kxr_controller/PressureControlActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','kxr_controller/PressureControlGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PressureControlActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = kxr_controller.msg.PressureControlGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = kxr_controller.msg.PressureControlGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_H3f().pack(_x.goal.board_idx, _x.goal.trigger_pressure, _x.goal.target_pressure, _x.goal.release_duration))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.board_idx, _x.goal.trigger_pressure, _x.goal.target_pressure, _x.goal.release_duration,) = _get_struct_H3f().unpack(str[start:end])
      return self
